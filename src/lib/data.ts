...
export const usersData = [
  {
    ...
    loginId: 'cro.demol',
    organization: 'CRO_Demo',
    email: 'CRO@symetricsystems.com',
    status: 'active'
  },
  {
    firstName: 'CROI',
    lastName: 'Project Manager',
    loginId: 'crol.demol',
    organization: 'SyMetric',
    email: 'crol@symetricsystems.com',
    status: 'active'
  },
  {
    firstName: 'dbp2',
    ...
    loginId: 'dbp2.demol',
    organization: 'SyMetric',
    email: 'dbp2@symetricsystems.com',
    status: 'active'
  },
  {
    firstName: 'SiteCoordinator1',
    lastName: '',
    loginId: 'sc2.demol',
    organization: 'Investigation_Site2_Demo',
    email: 'site2@symetricsystems.com',
    status: 'active'
  },
    {
    firstName: 'SiteCoordinator2',
    lastName: '',
    loginId: 'scl.demol',
    organization: 'investigation_Site_Demo',
    email: 'sitel@symetricsystems.com',
    status: 'active'
  },
  {
    firstName: 'Sponsor Project Manager',
    lastName: '',
    loginId: 'spm.demol',
    organization: 'Sponsor_Demo',
    email: 'sponsor@symetricsystems.com',
    status: 'active'
  },
  {
    firstName: 'dbp',
  ...
  },
  {
    ...
    lastName: '',
    loginId: 'wh.Demol',
    organization: 'Warehouse_Demo',
    email: 'warehouse@symetricsystems.com',
    status: 'active'
  }
];
