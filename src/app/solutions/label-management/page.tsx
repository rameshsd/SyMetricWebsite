...
import { LayoutGrid, ClipboardList, QrCode, GitPullRequest, Settings, ScanEye, type LucideIcon, MessageSquare } from 'lucide-react';
    ...
    return (
        <>
            <SyMetricBusinessAI 
              ...
              heroImageId="label-management-page-hero"
            />
