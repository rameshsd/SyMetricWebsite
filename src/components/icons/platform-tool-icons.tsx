...
// Quick manual-visual tests (usage examples)
// These lines are safe to delete in real usage but help verify build & rendering.
// <IdentityAccessIcon className="h-10 w-10 text-fuchsia-400" />
// <OrganizationIcon className="h-10 w-10 text-fuchsia-400" />