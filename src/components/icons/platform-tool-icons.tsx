...
export const SuppliesIcon: React.FC<IconProps> = ({ className }) => (
  <RawSVG className={className} svg={`<svg fill="#a73bb5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#a73bb5"> ... FULL SVG CONTENT ... </svg>`} />
);

// 5. Subject Management (exact SVG)
export const SubjectIcon: React.FC<IconProps> = ({ className }) => (
  <RawSVG className={className} svg={`<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg"> ... FULL SVG CONTENT ... </svg>`} />
);
