    ...
    <section className="py-20 bg-background">
      <div className="container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {toolsData.map(tool => (
            <div key={tool.id} className="bg-accent/50 dark:bg-accent/10 p-8 rounded-2xl flex flex-col text-left h-full">
              <h3 className="text-2xl font-bold text-foreground">{tool.label}</h3>
